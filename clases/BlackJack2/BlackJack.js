...
var BlackJack = /** @class */ (function (_super) {
    ...
    BlackJack.prototype.apostar = function (jugador) {
        ...
        if (this.apuestaActual >= jugador.getACredito()) {
            funciones.mensajeAlerta("La apuesta debe serdir\n           menor o igual a su credito de $ ".concat(jugador.getACredito()), "Rojo");
        }
        else {
            ...
            funciones.mensajeAlerta("Apostando ".concat(this.apuestaActual, " pesos..."), "Azul");
            this.jugar();
            premio = this.pagar();
            jugador.setCredito(jugador.getACredito() + premio);
            funciones.mensajeAlerta(premio > 0 ? "\u00A1Ganaste ".concat(this.apuestaActual, " pesos!") : "Lo siento, perdiste.", premio > 0 ? "Rojo" : "Azul");
            funciones.mensajeAlerta("Tu cr\u00E9dito actual es de ".concat(jugador.getACredito()), "Rojo");
        }
    };
    //-------------------------------------------------------------------------------------------------------------- 
