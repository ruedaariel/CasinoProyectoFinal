...
var Tragamonedas = /** @class */ (function (_super) {
    ...
    Tragamonedas.prototype.apostar = function (jugador) {
        ...
        this.cantApostada = funciones.validarValidezApuesta("Realice su apuesta comprendida entre $ ".concat(this.apuestaMinima, " y $ ").concat(this.apuestaMaxima, " "), this.apuestaMinima, this.apuestaMaxima, jugador.getACredito());
